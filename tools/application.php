...
<div class="signup-form">
    <form action="application.php" method="post">
		<h2>KRA APPLICATION</h2>
		<p class="hint-text">Provide the following details to enable us apply kra PIN your returns</p>
        <div class="form-group">
            ...
            <div class="form-group">
            <div class="row">
				<div class="col"><input type="text" class="form-control" name="IDNO" placeholder="ID Number" required="required"></div>
			</div>
			</div>
            <div class="form-group">
            <div class="row">
            ...
            <div class="form-group">
            <div class="row">
				<div class="col"><input type="text" class="form-control" name="adress" placeholder="Postal Adress" required="required"></div>
			</div>
			</div>
            <div class="form-group">
            <div class="row">
				<div class="col"><input type="text" class="form-control" name="location" placeholder="county,sub-county,ward" required="required"></div>
			</div>
			</div>
            <div class="form-group">
			<div class="row">
