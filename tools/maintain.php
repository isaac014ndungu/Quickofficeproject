...
<div class="signup-form">
    <form action="maintain.php" method="post">
		<h2>Maintainance</h2>
		<p class="hint-text">All electronics require maintainace for smoooth running</p>
        ...
        <div class="form-group">
            <select class="form-control" id="exampleFormControlSelect1" name="what" aria-placeholder="select">
		...
		<div class="form-group">
            <textarea name="here" class="form-control" placeholder="Describe the kindof maintainance" id="describe" cols="40" rows="2" maxlength="50" >
           Describe The kind of Maintainance
        </textarea>
        </div>        
		<div class="form-group">
